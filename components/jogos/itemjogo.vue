<template>
	<div>
		...
		<div class="grid grid-cols-2 gap-3">
			...
			<div class="px-3 border border-gray-300 rounded-lg flex items-center bg-white shadow-md" v-for="item in jogos.partidas" :key="item.hora">
